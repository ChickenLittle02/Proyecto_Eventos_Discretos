...
- Implementar análisis estadístico multi-run:
  ...
  - crear `src/multi_run.py` para ejecutar varias corridas independientes ✅
  - generar `results/multi_run_summary.csv` ✅

Siguientes pasos pendientes para completar la Opción B:
...
- Opcional: incluir criterio de parada por error estándar del estimador (capítulo 4).
- Mejorar el informe con gráficos adicionales y análisis comparativos por tipo de servicio y recurso.
